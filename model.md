...
$\alpha$ | $10^{-5} / \text{frog} / \text{day}$ | see Claude `literature_params` parameter estimation documents - I chose something near the middle of the general range it gave. This according to Claude doesn't have a direct estimation in the literature for the Green and Golden Bell Frogs, but the frogs get sick from much less fungus than most other frogs, so this infection parameter is on the higher range for all frog species.
